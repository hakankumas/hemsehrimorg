...
<head>
    ...
    <title>hemsehrim.org | Üye Girişi</title>
    ...
    <section class="header" id="home">
        <div class="container text-center">
            <form action="/hemsehrimorg/member/process.php" method="POST" class="contact-form col-md-10 col-lg-8 m-auto bg-light rounded p-5">
                <h1 class="section-title mb-5 bg-light">Üye Girişi</h1>
                <div class="form-row">
                    <label for="member_username">Kullanıcı Adınız</label>
                    <div class="form-group col-sm-12 mb-4">
                        <input type="text" name="member_username" id="member_username" size="50" class="form-control" placeholder="" required autofocus>
                    </div>

                    <label for="member_password">Şifreniz</label>
                    <div class="form-group col-sm-12 mb-3">
                        <input type="password" name="member_password" id="member_password" size="50" class="form-control" placeholder="" required>
                    </div>

                    <div class="form-group col-sm-12">
                        <input type="submit" name="member_login" class="btn btn-lg btn-primary rounded">
                    </div>
                </div>
            </form>
        </div>
