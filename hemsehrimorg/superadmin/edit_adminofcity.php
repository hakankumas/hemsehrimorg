...
include("edit_adminofcity-query1.php");
include("edit_adminofcity-query2.php");
...
<head>
  ...
  <title>hemsehrim.org | Şehir Yöneticisi Bilgilerini Düzenle</title>
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseAdmin"
          ...
          <i class="fa fa-eye ml-2 mr-2"></i>
          <span class="mx-1 px-1">Admin</span>
        </a>
        <div id="collapseAdmin" class="collapse" aria-labelledby="headingAdmin" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Admin</h6>
            <a class="collapse-item" href="add_admin.php">Ekle</a>
            <a class="collapse-item" href="edit_admin.php">Düzenle</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Şehir Yöneticisi Bilgileri</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item">Ana Sayfa</></li>
              <li class="breadcrumb-item">Şehir Yöneticisi</li>
              <li class="breadcrumb-item active" aria-current="page">Şehir Yöneticisi Bilgileri</li>
            </ol>
          </div>
          ...
          <div class="row">
            <div class="col-lg-5">
              <div class="card mb-4">
                <div class="table-responsive p-3">
                  <h2>Şehir Yöneticileri</h2>
                  <br>
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    <thead class="thead-light">
                      <tr>
                        <th>Şehir Yöneticisi Kullanıcı Adı</th>
                        <th style="text-align:center;">Güncelle</th>
                        <th style="text-align:center;">Sil</th>
                      </tr>
                    </thead>
                    <tbody>
                    <?php foreach ($adminofcity_list as $adminofcity){?>
                      <tr>
                        <td><?= "@".$adminofcity->adminofcity_username ?></td>
                        <td style="text-align:center; width:150px;"><a href="search.php?editAdminofcity_adminofcityUsername=<?= $adminofcity->adminofcity_username ?>" class="btn btn-success text-white" target="_blank">Güncelle</a></td>
                        <td style="text-align:center; width:100px;"><a href="delete.php?editAdminofcity_adminofcityUsername=<?= $adminofcity->adminofcity_username ?>" class="btn btn-danger text-white">Sil</a></td>
                      </tr>
                    <?php } ?>
                    </tbody>
                  </table>
            ...
            <div class="col-lg-7">
              <div class="card mb-4">
                <div class="table-responsive p-3">
                  <h2>Şehirler ve Yöneticileri</h2>
                  <br>
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    <thead class="thead-light">
                      <tr>
                        <th hidden>Şehir & Şehir Yöneticisi ID</th>
                        <th>Şehrin Kullanıcı Adı</th>
                        <th>Şehir Yöneticisinin Kullanıcı Adı</th>
                        <th style="text-align:center;">Güncelle</th>
                        <th style="text-align:center;">Sil</th>
                      </tr>
                    </thead>
                    <tbody>
                    <?php foreach ($city_adminofcity_list as $city_adminofcity){?>
                      <tr>
                        <td hidden><?= $city_adminofcity->city_adminofcity_id ?></td>
                        <td><?= "@".$city_adminofcity->city_username ?></td>
                        <td><?= "@".$city_adminofcity->adminofcity_username ?></td>
                        <td style="text-align:center; width:150px;"><a href="search.php?editAdminofcity_adminofcityID=<?= $city_adminofcity->city_adminofcity_id ?>" class="btn btn-success text-white" target="_blank">Güncelle</a></td>
                        <td style="text-align:center; width:100px;"><a href="delete.php?editAdminofcity_adminofcityID=<?= $city_adminofcity->city_adminofcity_id ?>" class="btn btn-danger text-white">Sil</a></td>
                      </tr>
                    <?php } ?>
                    </tbody>
                  </table>
