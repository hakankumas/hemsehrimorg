...
<head>
  ...
  <title>hemsehrim.org | Admin Ekle</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Admin Ekle</h1>
            <ol class="breadcrumb">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form action="process.php" method="POST">
                    <label for="exampleInputEmail12">Kullanıcı Adı</label>
                    <div class="input-group mb-3">
                      <div class="input-group-prepend">
                        <span class="input-group-text" id="basic-addon1">@</span>
                      </div>
                      <input type="text" class="form-control" id="exampleInputEmail12" name="admin_username" placeholder="" aria-label="Username" aria-describedby="basic-addon1" required autofocus>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Şifre</label>
                      <input type="text" class="form-control" id="exampleInputPassword1" name="admin_password" placeholder="" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlSelect1">Admin Türü</label>
                      <select class="form-control" id="exampleFormControlSelect1" name="admin_type" required>
                        <option value="" selected></option>
                        <option value="Superadmin">Superadmin</option>
                        <option value="Admin">Admin</option>
                      </select>
                    </div>
                    <button type="submit" class="btn btn-lg btn-success btn-icon-split mt-3" name="add_admin">
