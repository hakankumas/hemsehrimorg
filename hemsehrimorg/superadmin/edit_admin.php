...
<head>
  ...
  <title>hemsehrim.org | Admin Bilgilerini Düzenle</title>
                  ...
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <?php foreach ($admin_list as $admin){?>
                      <tr>
                        ...
                        <td style="text-align:center; width:150px;"><a href="search.php?editAdmin_adminUsername=<?= $admin->admin_username ?>" class="btn btn-success text-white" target="_blank">Güncelle</a></td>
                        <td style="text-align:center; width:100px;"><a href="delete.php?editAdmin_adminUsername=<?= $admin->admin_username ?>" class="btn btn-danger text-white">Sil</a></td>
                      </tr>
                    <?php } ?>
                    </tbody>
                  </table>
