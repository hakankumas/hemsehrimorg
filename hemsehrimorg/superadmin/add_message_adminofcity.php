...
include("add_message_adminofcity-query1.php");
...
<head>
  ...
  <title>hemsehrim.org | Şehir Yöneticilerine Mesaj Gönderme</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Mesaj - Şehir Yöneticisi</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-6">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Şehir Yöneticilerine Mesaj Gönder!</h6>
                </div>
                <div class="card-body">
                  <form action="process.php" method="POST">
                    <div class="form-group">
                      <label for="adminofcity_username">Şehir Yöneticisi</label>
                      <select class="form-control" id="adminofcity_username" name="adminofcity_username" required>
                        <option value="" disabled selected></option>
                        <?php foreach ($adminofcity_list as $adminofcity){?>
                        <option value="<?= $adminofcity->adminofcity_username ?>"><?= $adminofcity->adminofcity_username ?></option>
                        <?php } ?>
                      </select>
                    </div>
                    <div class="form-group">
                      <label for="admintoadminofcity_message_title">Mesaj Başlığı</label>
                      <input type="text" class="form-control" id="admintoadminofcity_message_title" name="admintoadminofcity_message_title" placeholder="" required>
                    </div>
                    <div class="form-group">
                      <label for="admintoadminofcity_message_content">Mesaj Metni</label>
                      <textarea class="form-control" id="admintoadminofcity_message_content" name="admintoadminofcity_message_content" rows="3"required></textarea>
                    </div>
                    <button type="submit" class="btn btn-lg btn-success btn-icon-split mt-3" name="add_message_admintoadminofcity">
