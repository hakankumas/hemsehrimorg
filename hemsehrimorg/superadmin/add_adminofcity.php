...
include("add_adminofcity-query1.php");
include("add_adminofcity-query2.php");
...
<head>
  ...
  <title>hemsehrim.org | Şehir Yöneticisi Ekle</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Şehir Yöneticisi Ekle</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item">Ana Sayfa</li>
              <li class="breadcrumb-item">Şehir Yöneticisi</li>
              <li class="breadcrumb-item active" aria-current="page">Şehir Yöneticisi Ekle</li>
            </ol>
          </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Yeni Bir Şehir Yöneticisi Ekle</h6>
                </div>
                <div class="card-body">
                  <form action="process.php" method="POST">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail" name="adminofcity_username" placeholder="" aria-label="Username" aria-describedby="basic-addon1" autofocus required>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputPassword1">Şifre</label>
                      <input type="text" class="form-control" id="exampleInputPassword1" name="adminofcity_password" placeholder="" required>
                    </div>

                    <button type="submit" class="btn btn-lg btn-success btn-icon-split mt-3" name="add_adminofcity">
            ...
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Şehir Yöneticisini Bir Şehirle İlişkilendir</h6>
                </div>
                <div class="card-body">
                  <form action="process.php" method="POST">
                    <div class="form-group">
                      <label for="exampleFormControlSelect1">Şehir</label>
                      <select class="form-control" id="exampleFormControlSelect1" name="city_username" required>
                        <option value="" disabled selected></option>
                        <?php foreach ($cities as $city){?>
                        <option value="<?= $city->city_username ?>"><?= $city->city_name ?></option>
                        <?php } ?>
                      </select>
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlSelect1">Şehir Yöneticisi</label>
                      <select class="form-control" id="exampleFormControlSelect1" name="adminofcity_username" required>
                        <option value="" disabled selected></option>
                        <?php foreach ($adminofcities as $aoc){?>
                        <option value="<?= $aoc->adminofcity_username ?>"><?= $aoc->adminofcity_username ?></option>
                        <?php } ?>
                      </select>
                    </div>
                    <button type="submit" class="btn btn-lg btn-success btn-icon-split mt-3" name="add_city_adminofcity">
                      <span class="icon text-white-100"><i class="fas fa-check"></i></span>
                      <span class="text">Tamamla</span>
                    </button>
                  </form>
