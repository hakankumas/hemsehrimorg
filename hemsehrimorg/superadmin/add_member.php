...
<head>
  ...
  <title>hemsehrim.org | Üye Ekle</title>
                ...
                <div class="card-body">
                  <form action="process.php" method="POST">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail" name="member_username" placeholder="" aria-label="Username" aria-describedby="basic-addon1" autofocus required>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputPassword1">Şifre</label>
                      <input type="text" class="form-control" id="exampleInputPassword1" name="member_password" placeholder="" required>
                    </div>

                    <button type="submit" class="btn btn-lg btn-success btn-icon-split mt-3" name="add_member">
