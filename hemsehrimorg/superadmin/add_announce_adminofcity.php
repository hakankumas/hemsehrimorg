...
<head>
  ...
  <title>hemsehrim.org | Şehir Yöneticileri için Genel Bir Duyuru Yayınla</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Duyuru - Şehir Yöneticisi</h1>
            <ol class="breadcrumb">
          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="alert alert-danger alert-dismissible" role="alert">
                ...
                Duyuru, Tüm Şehir Yöneticilerine Bildirilecektir!
              </div>
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Şehir Yöneticileri için Genel Bir Duyuru Yayınla!</h6>
                </div>
                <div class="card-body">
                  <form action="process.php" method="POST">
                    <div class="form-group">
                      <label for="admintoadminofcity_announce_title">Duyuru Başlığı</label>
                      <input type="text" class="form-control" id="admintoadminofcity_announce_title" name="admintoadminofcity_announce_title" placeholder="" required autofocus>
                    </div>
                    <div class="form-group">
                      <label for="admintoadminofcity_announce_content">Duyuru Metni</label>
                      <textarea class="form-control" id="admintoadminofcity_announce_content" name="admintoadminofcity_announce_content" rows="3"required></textarea>
                    </div>
                    <button type="submit" class="btn btn-lg btn-success btn-icon-split mt-3" name="add_announce_admintoadminofcity">
