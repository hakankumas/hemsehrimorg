...
include("index-query1.php");
include("index-query2.php");
include("index-query3.php");
include("index-query4.php");
include("index-query5.php");
include("index-query6.php");
include("index-query7.php");
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <!-- Container Fluid-->
        <div class="container-fluid pl-5" id="container-wrapper">
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold mb-1">SUPERADMİN</div>
                      <?php foreach ($count_superadmin as $superadmin){?>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $superadmin->numberofsuperadmin ?></div>
                      <?php } ?>
                    </div>
                    <div class="col-auto">
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold mb-1">ADMİN</div>
                      <?php foreach ($count_admin as $admin){?>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $admin->numberofadmin ?></div>
                      <?php } ?>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-5 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold mb-1">ŞEHİR</div>
                      <?php foreach ($count_city as $city){?>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $city->numberofcity ?></div>
                      <?php } ?>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-5 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold mb-1">ŞEHİR YÖNETİCİSİ</div>
                      <?php foreach ($count_adminofcity as $adminofcity){?>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $adminofcity->numberofadminofcity ?></div>
                      <?php } ?>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-5 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold mb-1">GEZİ ÖNERİSİ</div>
                      <?php foreach ($count_postofcity as $postofcity){?>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $postofcity->numberofpostofcity ?></div>
                      <?php } ?>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-5 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold mb-1">DUYURU VE ETKİNLİK</div>
                      <?php foreach ($count_noticeofcity as $noticeofcity){?>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $noticeofcity->numberofnoticeofcity ?></div>
                      <?php } ?>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-5 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold mb-1">ÜYE</div>
                      <?php foreach ($count_member as $member){?>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $member->numberofmember ?></div>
                      <?php } ?>
                    </div>
                    <div class="col-auto">
