...
<head>
  ...
  <title>hemsehrim.org | Şehir Ekle</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Şehir Ekle</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item">Ana Sayfa</li>
              <li class="breadcrumb-item">Şehir</li>
              <li class="breadcrumb-item active" aria-current="page">Şehir Ekle</li>
            </ol>
          </div>
                ...
                <div class="card-body">
                  <form action="/hemsehrimorg/tools/process-admin.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="exampleInputPassword1">Şehrin Adı</label>
                      <input type="text" class="form-control" id="exampleInputPassword1" name="city_name" placeholder="" required autofocus>
                    </div>

                    <label for="exampleInputEmail">Şehrin Kullanıcı Adı</label>
                    <div class="input-group mb-3">
                      <div class="input-group-prepend">
                        <span class="input-group-text" id="basic-addon1">@</span>
                      </div>
                      <input type="text" class="form-control" id="exampleInputEmail" name="city_username" placeholder="" aria-label="Username" aria-describedby="basic-addon1" required>
                    </div>

                    <div class="form-group">
                      <label for="formFile" class="form-label">Şehrin Profil Resmi</label>
                      <input class="form-control" type="file" id="formFile" name="city_img" accept="image/*" required>
                    </div>
                    
                    <button type="submit" class="btn btn-lg btn-success btn-icon-split mt-3" name="superadmin_add_city">
