...
<head>
  ...
  <title>hemsehrim.org | Şehir Bilgilerini Düzenle</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Şehir Bilgileri</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item">Ana Sayfa</></li>
              <li class="breadcrumb-item">Şehir</li>
              <li class="breadcrumb-item active" aria-current="page">Şehir Bilgileri</li>
            </ol>
          </div>
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    <thead class="thead-light">
                      <tr>
                        <th style="text-align:center;">Şehir Resmi</th>
                        <th>Şehir Adı</th>
                        <th>Şehir Kullanıcı Adı</th>
                    ...
                    <?php foreach ($city_list as $city){?>
                      <tr>
                        ...
                        <td style="text-align:center; width:150px;"><a href="search.php?editCity_cityUsername=<?= $city->city_username ?>" class="btn btn-success text-white" target="_blank">Güncelle</a></td>
                        <td style="text-align:center; width:100px;"><a href="delete.php?editCity_cityUsername=<?= $city->city_username ?>" class="btn btn-danger text-white">Sil</a></td>
                      </tr>
                    <?php } ?>
                    </tbody>
                  </table>
