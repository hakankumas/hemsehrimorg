                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="admin_username">@</span>
                          </div>
                          <input disabled type="text" class="form-control" id="admin_username" name="admin_username" aria-label="Username" aria-describedby="admin_username" autofocus 
                            value="<?= $admin->admin_username ?>" placeholder="<?= $admin->admin_username ?>">
                        </div>
                    </div>
                    <div class="form-group">
                      <label for="admin_name">Ad</label>
                      <input type="text" class="form-control" id="admin_name" name="admin_name" 
                            value="<?= $admin->admin_name ?>" placeholder="<?= $admin->admin_name ?>">
                    </div>
                    <div class="form-group">
                      <label for="admin_surname">Soyad</label>
                      <input type="text" class="form-control" id="admin_surname" name="admin_surname"
                            value="<?= $admin->admin_surname ?>" placeholder="<?= $admin->admin_surname ?>">
                    </div>
                    <div class="form-group">
                      <label for="gender_type">Cinsiyet</label>
                      <select class="form-control" id="gender_type" name="gender_type">
                        <option value="<?= $admin->gender_type ?>" selected><?= $admin->gender_type ?></option>
                        <option value="Erkek">Erkek</option>
                        <option value="Kadın">Kadın</option>
                      </select>
                    </div>
                    <div class="form-group">
                      <label for="admin_telephone">Telefon</label>
                      <input type="text" class="form-control" id="admin_telephone" name="admin_telephone" maxlength="10"
                            value="<?= $admin->admin_telephone ?>" placeholder="<?= $admin->admin_telephone ?>">
                    </div>
                    <div class="form-group">
                      <label for="admin_mail">Mail Adresi</label>
                      <input type="email" class="form-control" id="admin_mail" name="admin_mail"
                            value="<?= $admin->admin_mail ?>" placeholder="<?= $admin->admin_mail ?>">
                    </div>                             
                    
                    <button type="submit" class="btn btn-lg btn-success btn-icon-split mt-3" name="update_admin_info">
            ...
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  ...
                  <?php foreach ($admin_info as $admin){?>
                    <img src="<?= $admin->admin_img ?>" style="width: 200px;" class="rounded">  
                    <br>                     
                    <div class="form-group mt-5">
                      <label for="admin_img">Profil Resmi</label>
                      <input type="file" class="form-control" id="admin_img" name="admin_img" accept="image/*" required>
                    </div>  
                    <button type="submit" class="btn btn-lg btn-success btn-icon-split mt-3" name="superadmin_update_pp">
                      <span class="icon text-white-100"><i class="fas fa-check"></i></span>
                      <span class="text">Tamamla</span>
                    </button>
                    <?php } ?>                        
