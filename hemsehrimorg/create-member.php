...
<head>
    ...
    <title>hemsehrim.org | Üye Kayıt Ekranı</title>
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <section class="header" id="home">
        <div class="container text-center">
            <form action="/hemsehrimorg/member/process.php" method="POST" class="contact-form col-md-10 col-lg-8 m-auto bg-light rounded p-5">
                <h1 class="section-title mb-5 bg-light">Üye Kayıt Ekranı</h1>
                <div class="form-row">
                    ...
                    <div class="form-group col-sm-12 mb-4">
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" id="member_username" name="member_username" placeholder="Kullanıcı Adı" aria-label="Username" aria-describedby="basic-addon1" required autofocus>
                        </div>
                    </div>
                    <label for="member_password">Şifre</label>
                    <div class="form-group col-sm-12 mb-3">
                        <input type="password" name="member_password" id="member_password" size="50" class="form-control" placeholder="Şifre" required>
                    </div>            
                    <div class="form-group col-sm-12">
                        <input type="submit" name="member_signin" class="btn btn-lg btn-primary rounded">
                    </div>
                </div>
            </form>
        </div>
