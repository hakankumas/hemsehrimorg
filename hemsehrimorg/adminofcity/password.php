                ...
                <div class="card-body">
                  <form action="process.php" method="POST">
                    <div class="form-group">
                        <label for="now_adminofcity_password">Mevcut Şifre</label>
                        <input type="text" class="form-control" id="now_adminofcity_password" name="now_adminofcity_password" required autofocus>
                    </div>
                    <div class="form-group">
                        <label for="new_adminofcity_password">Yeni Şifre</label>
                        <input type="text" class="form-control" id="new_adminofcity_password" name="new_adminofcity_password" required>
                    </div>
                    <div class="form-group">
                        <label for="new2_adminofcity_password">Tekrardan Yeni Şifre</label>
                        <input type="text" class="form-control" id="new2_adminofcity_password" name="new2_adminofcity_password" required>
                    </div>
                    <button type="submit" class="btn btn-lg btn-success btn-icon-split mt-3" name="update_adminofcity_password">
