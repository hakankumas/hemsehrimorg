...
<head>
  ...
  <title>hemsehrim.org | Talep Bildir</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid pl-5" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Talep Bildir</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Ana Sayfa</a></li>
              <li class="breadcrumb-item active" aria-current="page">Talep Bildir</li>
            </ol>
          </div>
            ...
            <div class="col-lg-6">
                <div class="card mb-5 pb-5">
                    <div class="alert alert-danger bg-danger text-white alert-dismissible" role="alert">
                        ...
                        <strong>Talebinizi Detaylı Bir Şekilde Açıklayınız!</strong>
                    </div>
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                      <h6 class="m-0 font-weight-bold text-primary">Talep Metni Ekle</h6>
                    </div>
                    <div class="card-body">
                        <form action="process.php" method="POST">
                            <div class="form-group">
                                <label for="adminofcitytoadmin_title">Talep Başlığı</label>
                                <input type="text" class="form-control" id="adminofcitytoadmin_title" name="adminofcitytoadmin_title" required autofocus>
                            </div>
                            <div class="form-group">
                                <label for="adminofcitytoadmin_content">Talep Metni</label>
                                <textarea class="form-control" id="adminofcitytoadmin_content" name="adminofcitytoadmin_content" rows="3" required></textarea>
                            </div>
                            <button type="submit" class="btn btn-lg btn-success btn-icon-split mt-3" name="adminofcitytoadmin_message">
