...
<head>
  ...
  <title>hemsehrim.org | Gezi Önerisi Oluştur</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Gezi Önerisi Oluştur</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item">Ana Sayfa</li>
              <li class="breadcrumb-item">Gezi Önerisi</li>
              <li class="breadcrumb-item active" aria-current="page">Gezi Önerisi Oluştur</li>
            </ol>
          </div>
                ...
                <div class="card-body">
                  <form action="process.php" method="POST" class="form-group" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="postofcity_title">Başlık</label>
                      <input type="text" class="form-control" id="postofcity_title" name="postofcity_title" placeholder="" required autofocus>
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlTextarea1">Açıklama</label>
                      <textarea class="form-control" id="exampleFormControlTextarea1" name="postofcity_content" rows="4" placeholder="" required></textarea>
                    </div>
                    <div class="form-group">
                      <label for="postofcity_img">Görsel</label>
                      <input type="file" class="form-control" id="postofcity_img" name="postofcity_img" placeholder="" required  accept="image/*">
                    </div>
                    <button type="submit" class="btn btn-lg btn-success btn-icon-split mt-3" name="publish_post">
