...
include('lookat_post-query1.php');
...
<head>
  ...
  <title>hemsehrim.org - Gezi Önerileri</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Gezi Önerileri</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Ana Sayfa</a></li>
              <li class="breadcrumb-item">Gezi Önerileri</a></li>
              <li class="breadcrumb-item active" aria-current="page">Gezi Önerilerini Düzenle</li>
            </ol>
          </div>
          <!-- Row -->
          <div class="row mb-5 pb-5">
            ...
            <?php foreach($postofcity as $poc){?>
                <div class="card-header mt-5 ml-3 mr-3">
                  <h1 class="font-weight-bold text-primary mb-4" style="text-align: center;"><?= $poc->postofcity_title?></h1>
                  <img src="<?= $poc->postofcity_img?>" style="display: block; margin: auto; width:750px;">
                  <p class="ml-5 mr-5 mt-5 mb-5" style="display: block; margin: auto;  text-indent:50px;text-align:justify;"><?= $poc->postofcity_content?></p>
                  <a href="delete.php?postofcityDelete_postofcityID=<?= $poc->postofcity_id ?>"><button type="submit" name="postofcity_delete" style="display: block; margin: auto;" class="btn btn-lg btn-danger text-white pr-5 pl-5">Gezi Önerisini Sil</button></a>
