...
<head>
    ...
    <title>hemsehrim.org | Ana Sayfa | Gezi Önerisi</title>
    ...
    <nav class="navbar navbar-expand-md navbar-dark mb-4" style="background-color:#6777ef">
        ...
        <div class="collapse navbar-collapse ml-3" id="responsive" style="font-size:medium; font-weight:400;">
            <ul class="navbar navbar-nav mr-auto text-capitalize justify-content-center">
                <li class="nav-item"><a href="index.php" class="nav-link active">Ana Sayfa</a></li>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-8 mb-5 pb-5" >
                <div class="middle-column">
                    <div class="card" >
                        <?php foreach($cities_post as $cp){?>
                        <div class="card-body">
                            <br>
                            <div class="media">
                                <img src="<?= $cp->city_img?>" alt="img" width="55px" height="55px" class="rounded-circle mr-3 border border-secondary">
                                <div class="media-body">
                                    <h5 class="mt-3"><i><?= "@".$cp->city_username?></i></h5>
                                    <p class="text-justify text-center mt-4 text-primary" style="font-weight: bolder; font-size:x-large"><strong><?= $cp->postofcity_title?></strong></p>
                                    <img class="img-fluid shadow-sm img-thumbnail" src="/hemsehrimorg/adminofcity/<?= $cp->postofcity_img ?>">
                                    <p class="text-justify mt-4" style="text-indent:30px; font-weight: bolder;"><?= $cp->postofcity_content?></p>
                                    <div class="mt-5" style="border-bottom:3px double black;width:99%;"></div>
                                </div>
                                <p style="font-weight: bolder;"><i><?= $cp->postofcity_registerDate?></i></p>
                            </div>
                        </div>
                        <?php } ?>
                    </div>
