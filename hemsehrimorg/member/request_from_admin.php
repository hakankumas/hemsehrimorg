...
$query = $db->prepare("SELECT * FROM membertoadmin WHERE member_username=?");
$query->execute([$member_username]);
$request_from_admin = $query->fetchAll(PDO::FETCH_OBJ);
                        ...
                        <div class="card-body">
                            <form action="process.php" method="POST">
                                <div class="form-group">
                                    <label for="membertoadmin_title">Talep Başlığı</label>
                                    <input type="text" class="form-control" id="membertoadmin_title" name="membertoadmin_title" required autofocus>
                                </div>
                                <div class="form-group">
                                    <label for="membertoadmin_content">Talep Metni</label>
                                    <textarea class="form-control" id="membertoadmin_content" name="membertoadmin_content" rows="3" required></textarea>
                                </div>
                                <button type="submit" class="btn btn-lg btn-success btn-icon-split mt-3" name="membertoadmin_message">
